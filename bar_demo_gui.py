...
class BarDemoApp:
    ...
    def setup_keybinds(self) -> None:
        ...
        self.window.root.bind("<KeyRelease-Shift_L>", self.on_shift_commit)
        self.window.root.bind("<KeyRelease-Shift_R>", self.on_shift_commit)

    def on_shift_commit(self, event) -> None:
        self.window.commit_letter(self._current_prediction)
    ...
    def update_loop(self) -> None:
        ...
        if succ:
            ...
            if detection_rez.hand_landmarks:
                ...
                self._current_prediction = label
